...
- **実務**: 執筆者はPEファンドで太陽光・蓄電池EPC事業者への投資検討に従事しており、太陽光・蓄電池の普及ペースは業務上のマクロ変数そのもの。系統用蓄電池は容量市場（安定電源登録分の応札: 8万kW（2027実需給）→24万kW（2028）→169万kW（2029））・長期脱炭素電源オークション（初回で蓄電池109.2万kW落札）により**実需給2027年度から運開・参入が急拡大する見通し**であり、「爆発的普及の直前に均衡量を事前推定する」という本研究のタイミングは、EPCの受注環境・蓄電池投資の採算という実務の意思決定に直結する。なお分析は特定の投資ポジションから独立に行う。
- **学術**: 国内の市場構造変化研究は太陽光起点（九州）に厚い一方、風力起点は Sakaguchi & Fujii (2021) 等ごく少数で、風力倍増後（2023年〜）のデータでの分析は見当たらない（→ノート12）。
- **社会**: 風力×蓄電池（太陽光の影響を内包）の均衡量K\*は、北海道の系統計画・洋上風力の事業性・脱炭素政策に共通する関心事であり、答えは投資家にも政策にも意味を持つ。
...
**超ざっくり版（4行）**: ①データ確保（北海道・東北需給実績、いま〜2026/9）→ ②第一弾実証（風力×エリアプライスの分位点回帰＋帯域分解、2026年秋〜年内）→ ③北海道版価値算定（容量市場収益込み）＋構造モデル（2027年前半）→ ④均衡量K\*(R)推定・執筆（2027年後半〜2028/1提出）。
